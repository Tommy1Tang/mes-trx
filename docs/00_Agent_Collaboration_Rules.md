...
> 最后更新：2026-05-12
> 变更说明：新增IVD MES开发口径文件读取规则，更新文档索引
...
| 需求确认、变更评审 | 00_Blueprint.md + 00_Requirement_Index.md + 05_Change_Log.md |
...
- 再加载 `MES系统基础表清单_按优先级.md` 中对应层的表清单
- 最后加载 `MES系统基础表逐字段数据字典_按优先级_pgsql.csv` 中对应表的字段定义
...
- 负责更新`00_Requirement_Index.md`和各业务模块需求文档
