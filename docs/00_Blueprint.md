...
| 00 | 00_Task_Kanban.md | 任务看板、Agent异步消息总线 | 任务分工、状态同步时读取 |
...
| 32 | 32_前端页面开发风格规范.md | MES前端页面统一风格、组件、布局、按钮、权限、字典、验收规范 | 前端页面设计、前端开发、页面验收时必须读取 |
...
- 前端页面开发必须读取`32_前端页面开发风格规范.md`，并优先复用RuoYi现有页面模式
