...
source_section: "2.8 SAP PM集成"
requirements: ["REQ-PM-001", "REQ-PM-002"]
...
|--------|----------|--------|----------|----------|----------|
| REQ-PM-001 | 设备可用状态同步 | P1 | 从SAP PM接收设备维修、保养、锁定/解锁和可用状态，供MES开工校验和联锁使用 | 状态同步及时 | 系统自动 |
| REQ-PM-002 | 维保到期状态引用 | P1 | MES引用SAP PM维保到期结果，维保过期时可提示或阻断关键工序开工 | 校验准确 | 系统自动 |
