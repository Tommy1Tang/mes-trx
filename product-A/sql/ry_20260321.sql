-- PostgreSQL 版 RuoYi 基础数据初始化脚本
-- 来源：ry_20260321.sql (MySQL → PostgreSQL 转换)
...
SELECT setval('sys_post_post_id_seq', 100);
...
SELECT setval('sys_notice_read_read_id_seq', 1);
...
SELECT setval('gen_table_table_id_seq', 1);
...
SELECT setval('gen_table_column_column_id_seq', 1);
